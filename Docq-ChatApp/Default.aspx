<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Docq_ChatApp.Default" %>
...
<body>
    <section class="center">
        <%--<form method="post" class="form" action="">
            ...
            <div class="formWrap">
                <button class="buton formSubmit" id="mainSliderformSubmit">Login</button>
            </div>
            ...
            <div class="links">
	            <a href="singup.aspx">Not A Member</a>
